...
class Bootstrap
{
    ...
    public static $root = '';
    //public static $baseUrl = 'http://www.ariskon.jclifecare.com/';
    public static $baseUrl = 'http://localhost/ariskon/';
    ...
    public static function setupSession()
    {
        try
    	{
                Zend_Session::setOptions(array(
    				'save_path' => self::$root . "/tmp/sessions",'.' => 7200,
                ));
    	...
    	{
            //lines commented by jm on 09072018 to run the application
