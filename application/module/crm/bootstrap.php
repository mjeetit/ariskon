...
class Bootstrap
{
    ...
    public static $baseUrl = 'http://localhost/ariskon/application/crm/';
    ...
    protected  function _initSiteRouters(){
        ...
        $this->appRoutes['crm_activity']= new Zend_Controller_Router_Route('crm/add',array('module'=>'crm','controller' => 'Activity','action' => 'add'));

        $this->appRoutes['crm_admin']= new Zend_Controller_Router_Route('crm/logout',array('module'=>'crm','controller' => 'Admin','action' => 'logout'));
       
        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'add'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'drpotential'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'getdoctor'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'editold'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'edit'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'view'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'print'));

        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'manualcrm'));
        
        $this->appRoutes['crm_appointment']= new Zend_Controller_Router_Route('crm/appointment',array('module'=>'crm','controller' => 'Appointment','action' => 'editproduct'));
    ...
    public static function setupPath()
    {
		...
		set_include_path(
		    $root . '/library' . PATH_SEPARATOR .
                    $root . '/application/crm' . PATH_SEPARATOR .
                    $root . '/application/crm/models' . PATH_SEPARATOR .
                    $root . '/application/crm/forms' . PATH_SEPARATOR .
                    get_include_path()
		);
    ...
    {	
        ...
        $layout=Zend_Layout::startMvc(
            array(
                'layoutPath' => self::$root . '/application/crm/layouts',
                'layout' => 'login'
                )
        );
