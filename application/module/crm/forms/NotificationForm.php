...
class Crm_Form_NotificationForm extends Zend_Form {
	...
	public function MessageForm(){
         ...
         $bunit->addMultiOptions(array('0'=>'--Select B.Unit--'));
		 ...
		 if($_SESSION['AdminLoginID']==1){
			 $department_id->setAttrib('onchange', 'changeStatusDepartment(this.value,"'.$data['department_id'].'")');
	      	...
	      	$department_id->setAttrib('onchange', 'getLowerDesination(this.value,"'.$data['department_id'].'")');
	  	}
