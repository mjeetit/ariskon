<?php
class Crm_PrivilegeController extends Zend_Controller_Action {
	var $session="";
	public $users;
	...
	public function editlevelprivilegeAction()
	{
		 ...
		 if($this->_request->isPost()){
			if($this->ObjModel->addDefaultPrivileges($this->view->filterdata)) {
				...
				$this->_redirect($this->_request->getControllerName().'/'.$this->getRequest()->getActionName().'?jkjmtoken='.$this->view->filterdata['token']);
			}
			else {
