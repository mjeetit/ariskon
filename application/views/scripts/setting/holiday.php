            ...
            <table id="myTable" class="tablesorter">
				...
				?>
				    <tr class="<?php echo  $class;?>">
			            <td align="center"><?php echo date('M-Y',strtotime($this->hilidayslist[$i]['month']))?>
                        </td>
            			<td align="center"><?php echo $this->hilidayslist[$i]['holiday_date']?>
                        </td>
                		<td align="center"><?php echo $this->hilidayslist[$i]['day']?>
                        </td>
                	    <td align="center"><?php echo $this->hilidayslist[$i]['holiday_name']?>
                        </td>
   					</tr>
					<?php }} else{ ?>
					<tr>
