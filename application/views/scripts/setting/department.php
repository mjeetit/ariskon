            ...
            <form action="">
                <table id="myTable" class="tablesorter">
                    <thead>
                        <tr>
							<td colspan="5">
                                <a href="<?php echo $this->url(array('controller'=>'Setting','action'=>'addnew','type'=>'Department'),'default',true)?>" class="button add">
                    ...
                    <tbody>
						...
						<tr class="<?php echo  $class;?>">
				            <td align="center">
                                <input type="checkbox" name="department_id" value="<?php echo $this->designation[$i]['department_id']?>" />
                            </td>

					        <td align="center"><?php echo $this->department[$i]['department_name']?></td>

						    <td align="center">
                                <a href="<?php echo $this->url(array('controller'=>'Setting','action'=>'editnew','type'=>'Department','department_id'=>$this->department[$i]['department_id']),'default',true)?>">
                                    <img src="<?php echo Bootstrap::$baseUrl;?>public/admin_images/pencil.gif" />
                                </a>
							</td>
						</tr>
						<?php }} else{ ?>
