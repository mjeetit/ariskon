					...
					<td style="border:none" align="center">
					 ...
					 <tbody>
						...
						<tr class="even">
							...
							<td><input type="text" name="number_of_approval" class="input-short" value="<?php echo $this->ExpSett['number_of_approval'];?>" /></td>
						</tr>
					    <tr class="odd">
							<td>Expense Type</td>
								<td><select name="expense_type" onchange="expsetting(this.value,'')" class="input-medium">
							...
							<tr><th>Expense Head</th><th>Expense Amount</th></tr>
						<tr><td colspan="2">
						 <table id="expense_table"></table>
						</td></tr>	
						<tr><td colspan="2"><input type="checkbox" name="updateemp"  />&nbsp;&nbsp;Do You Want To Update Employee Expense Template </td></tr>
						<tr>
						<td colspan="2"><input type="submit" name="submit" value="Add Setting"  class="submit-green"/></td>
						</tr>		
					 </tbody>
					</table>
				  </td>
