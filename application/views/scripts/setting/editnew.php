					  ...
					  <?php if($this->type=='Salaryhead'){?> 
						 <p>
							...
							<p>
                                ...
                                <input type="radio" name="credit_type" value="0" checked="checked" class="input-short" onclick="showcatpertboxx(this.value)" <?php if($this->EditNewRec['credit_type']=='0'){ echo 'checked="checked"'; }?> /> Fixed Amount
                                <input type="radio" name="credit_type" value="1" class="input-short" onclick="showcatpertboxx(this.value)"  <?php if($this->EditNewRec['credit_type']=='1'){ echo 'checked="checked"'; }?>/> By Percentage
                            </p>
							<p id="p_ctc_percentage" style="display:none">
                                <label>CTC Percentage</label>
                                 <input type="text" name="ctc_percentage" class="input-short"  value="<?php echo $this->EditNewRec['ctc_percentage'];?>"  />
                            </p>
							<script type="text/javascript">
							$(document).ready(function() {
								showcatpertboxx('<?php echo $this->EditNewRec['credit_type'];?>');
