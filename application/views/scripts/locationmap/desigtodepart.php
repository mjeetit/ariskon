 <div class="grid_12">
	            <!-- Example table -->
                <div class="module">
                	<h2><span>Designation To Department</span></h2>
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
							...
							<tr>
							<td colspan="5">
							<a href="<?php echo $this->url(array('controller'=>'Locationmap','action'=>'d2d'),'default',true)?>" class="button add">
                        	<span>Add Designation To Department<img src="<?php echo IMAGE_LINK;?>/plus-small.gif"  width="12" height="9" alt="Add Designation To Department" /></span>
                        </a>
					</td>
							</tr>
                                <tr>
                            ...
                            <tbody>
							 ...
							 if($this->desigtodepart){
								...
								<td align="center"><a href="<?php echo $this->url(array('controller'=>'Locationmap','action'=>'editlocationmap','desig_to_depart_id'=>$this->desigtodepart[$i]['desig_to_depart_id'],'Mode'=>'d2d'),'default',true)?>"><img src="<?php echo Bootstrap::$baseUrl;?>public/admin_images/pencil.gif" /></a>
								</td>
								</tr>
								<?php }} else{ ?>
								<tr>
