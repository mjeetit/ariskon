                ...
                <div class="module">
                     ...
                     <div class="module-body">
						...
						<table width="70%" style="border:none">
							...
							<thead>
							<tr><th colspan="2">Add <?php echo ucfirst($this->back);?></th>
							 </tr>
							<?php if($this->level==1){?> 
							  <tr class="even">
							  <td style="border:none">Comapny Name</td>
									<td style="border:none"><input type="text" name="company_name" class="input-medium"/></td>
								</tr>
							 <tr class="odd">
							  <td style="border:none" valign="top">Comapny Address</td>
									<td style="border:none"><textarea name="company_address" class="input-medium" rows="10"></textarea></td>
								</tr>	
							 <?php } ?> 
							  ...
							  <?php if($this->level==3){?> 
							   <tr>
									<td style="border:none">Country</td>
										<td style="border:none"><select name="country_id">
							 ...
							 <?php } ?>
							  <?php if($this->level==4){?> 
							   <tr>
									<td style="border:none">Business Unit</td>
										<td style="border:none"><select name="bunit_id">
								 ...
								 <tr>
									<td style="border:none">Zone Name</td>
										<td style="border:none"><input type="text" name="zone_name" class="input-medium"/></td>
								  </tr>
							 <?php } ?>
							 ...
							 <?php if($this->level==5){?> 
							   <tr>
								 ...
								 <tr>
									<td style="border:none">Zone Name</td>
										<td style="border:none"><select name="zone_id"  id="zone_id">
										<option value="">--Select Zone--</option>
										</select></td>
								  </tr>
								 <tr>
									<td style="border:none">Region Name</td>
										<td style="border:none"><input type="text" name="region_name" class="input-medium"/></td>
								  </tr>
							 <?php } ?>
								  ...
								  <tr>
								   ...
								   <tr>
									<td style="border:none">Street</td>
										<td style="border:none"><input name="street_name" type="text" class="input-medium" /></td>
								  </tr>
							 <?php } ?>
							 <tr>
