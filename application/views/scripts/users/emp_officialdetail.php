					...
					<tr>
					  ...
					  <tr class="odd">
							...
							<td width="40px">
								...
								<select name="designation_id" id="designation_id" onchange="changeStatusdesignation(this.value,'',<?php echo $this->UserDetail['sub_designation_id'];?>);"  class="input-medium">
