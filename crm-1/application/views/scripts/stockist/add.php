			    ...
			    <table style=" width:100%">
				  <thead>
					...
					<tr class="even">
					  ...
					  <td align="left" width="20%"><textarea name="name" rows="5" cols="25" required></textarea></td>
					  <td align="left" width="10%" class="bold_text">Address <span class="strick">*</span> :</td>
					  <td align="left" width="60%"><textarea name="address" rows="5" cols="25" required></textarea></td>
					</tr>
					...
					<tr class="event">
					  <td style="border:none" colspan="4">
					    <input type="submit" name="addaction" id="addaction" value="Save" />
