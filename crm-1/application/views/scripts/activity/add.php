				  ...
				  <thead>
				    <tr class="odd">
					  <td colspan="8" align="left" style="border:none">
					    <a href="<?php echo $this->url(array('controller'=>'Activity','action'=>'index'),'default',true)?>" class="button back">
					...
					<tr class="even">
					  <td align="left" width="20%">CRM Activity Name <span class="strick">*</span> :</td>
					  <td align="left" width="80%"><input type="text" name="activity_name" id="activity_name" required aria-required="true" class="input-medium" autofocus/></td>
					</tr>
					...
					<tr class="event">
					  <td style="border:none" colspan="2"><input type="submit" name="activityAdd" id="activityAdd" value="Save"></td>
					</tr>
				  </thead>
				</table>
			  </td>
