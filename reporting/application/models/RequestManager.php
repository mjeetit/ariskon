...
class RequestManager extends Zend_Custom
{
  ...
  public function MailForLeaverequest(){
       $select = $this->_db->select()
	   ...
	   $receiveremail  = (!empty($receivers[0]['Appemail']))?$receivers[0]['Appemail']:'info@jclifecare.com';
	   $receivername  = (!empty($receivers[0]['Receiver']))?$receivers[0]['Receiver']:'Info';
	   unset($ccarray[0]);
