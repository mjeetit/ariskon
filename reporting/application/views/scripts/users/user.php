 <div class="grid_12">
                ...
                <div class="module">
                    ...
                    <div class="module-table-body">
						...
						<td align="center"><?php echo $this->Users[$i]['passwowrd_text'];?></td>
						<td align="center"><?php echo $this->Users[$i]['dob'];?></td>
						<td align="center"  id="statusportion<?php echo $this->Users[$i]['user_id'];?>">
						<?php if($this->Users[$i]['login_status']=='1'){?>
						   <img src="<?php print IMAGE_LINK; ?>/icon_active.gif" align="absmiddle" alt="Inactive" border="0" 
				onclick="changeStatus('<?php echo 'employee_personaldetail';?>','<?php print $this->Users[$i]['user_id']; ?>','login_status','0','user_id');" title="Active" class="changeStatus" />
						<?php }else{?>
						<img src="<?php print IMAGE_LINK; ?>/icon_inactive.gif" align="absmiddle" alt="Active" border="0" 
				onclick="changeStatus('<?php echo 'employee_personaldetail';?>','<?php print $this->Users[$i]['user_id']; ?>','login_status','1','user_id');" title="Inactive"  class="changeStatus" />
						<?php }?>
						</td>
						<td align="center" id="user_portion<?php echo $this->Users[$i]['user_id'];?>">
						<?php if($this->Users[$i]['user_status']=='1'){?>
						   <img src="<?php print IMAGE_LINK; ?>/icon_active.gif" align="absmiddle" alt="Inactive" border="0" 
				onclick="changeStatusByportion('<?php echo 'employee_personaldetail';?>','<?php print $this->Users[$i]['user_id']; ?>','user_status','0','user_id','user_portion');" title="Active" class="changeStatus" />
						<?php }else{?>
						<img src="<?php print IMAGE_LINK; ?>/icon_inactive.gif" align="absmiddle" alt="Active" border="0" 
				onclick="changeStatusByportion('<?php echo 'employee_personaldetail';?>','<?php print $this->Users[$i]['user_id']; ?>','user_status','1','user_id','user_portion');" title="Inactive"  class="changeStatus" />
						<?php }?>
						</td>
						<td align="center">
					 ...
					 <a  onclick="fancyboxopenfordelete('<?php echo $this->url(array('controller'=>'Users','action'=>'changepassword','user_id'=>$this->Users[$i]['user_id']),'default',true)?>')"><img src="<?php echo Bootstrap::$baseUrl;?>public/admin_images/change-password-icon.png" title="Change Password" /></a>&nbsp;|
					 <a  onclick="fancyboxopenfordelete('<?php echo $this->url(array('controller'=>'Users','action'=>'delete','user_id'=>$this->Users[$i]['user_id'],'designation_id'=>$this->Users[$i]['designation_id']),'default',true)?>')"><img src="<?php echo Bootstrap::$baseUrl;?>public/admin_images/delete_image.png" title="Delete" /></a>
					 &nbsp;|
					 <a  href="<?php echo $this->url(array('controller'=>'Users','action'=>'userhistory','user_id'=>$this->Users[$i]['user_id']),'default',true)?>"><img src="<?php echo Bootstrap::$baseUrl;?>public/admin_images/history.png" title="History" /></a>
						</td>
								</tr>
								<?php }} else{ ?>
								<tr>
