                ...
                <div class="module">  
                    ...
                    <div class="module-table-body"> 
						...
						<form name="listFrom" id="listForm" action="" method="get" >
							<table width="96%" border="0" cellspacing="1" cellpadding="2">
							  ...
							  <tr class="odd">
								...
								<td width="20%" align="left" class="bold_text">Chemist :
								  <select name="token1">
									<option value="">-- Select Chemist --</option>
									<?php foreach($this->doctors as $doctor){
										$select = '';
										if($this->Filterdata['token1']==Class_Encryption::encode($doctor['chemist_id'])){
											$select = 'selected="selected"';
										}
									?>
									<option value="<?=Class_Encryption::encode($doctor['chemist_id'])?>" <?=$select?>><?=$doctor['chemist_name']?></option>
									<?php } ?>
								  </select>
								</td>
						...
						<table id="myTable" class="tablesorter">
						 ...
						 <td align="center">
						 <a href="<?=$this->url(array('controller'=>'Reporting','action'=>'chemistdetailreport','token'=>Class_Encryption::encode($visit['user_id']),'monthrange'=>$visit['visit_month']))?>"><img src="<?=Bootstrap::$baseUrl?>public/admin_images/view_detail.png" title="View Report" /></a>
						 </td>
						 </tr>
						 <?php } }  else{ ?>
						<tr>
