...
//$basename = 'http://www.ariskon.jclifecare.com/reporting';
$basename = 'http://localhost/ariskon/reporting';
?>
...
function fillheirarchy(){
		   ...
		   if(zbm !=''){
				   if(rbm == ''){
					 alert("Please Select RBM.");
				   }else if(abm == ''){
					 alert("Please Select ABM.");
				   }else if(be == ''){
					 alert("Please Select BE.");
				   }else{
					$("#listForm").submit();
				   }
		   }else if(rbm !=''){
		     ...
		     if(be == ''){
			  ...
			  if(be == ''){
				 alert("Please Select at least BE.");
			   }
   ...
   function getchild(selected_value,selectbox_id,design_id,selected_id){
	 $.ajax({
		url: '<?php echo $basename;?>/Ajax/getchildselecteduser',
		data: 'user_id='+selected_value+'&design_id='+design_id+'&selected_id='+selected_id,
		success: function(data) {
		   //alert(data);//return false;
  ...
  function gethq(selected_value,selectbox_id,design_id,selected_id){
	 $.ajax({
		url: '<?php echo $basename;?>/Ajax/getchildhq',
		data: 'user_id='+selected_value+'&design_id='+design_id+'&selected_id='+selected_id,
		success: function(data) {
		   //alert(data);//return false;
	   $("#"+selectbox_id).html(data);
  ...
  function getdotr(selected_value,selectbox_id,design_id,selected_id){
	 $.ajax({
		url: '<?php echo $basename;?>/Ajax/getchilddoctr',
		data: 'user_id='+selected_value+'&design_id='+design_id+'&selected_id='+selected_id,
		success: function(data) {
		   //alert(data);//return false;
	   $("#"+selectbox_id).html(data);
