							  ...
							  <td colspan="7">
								<table width="96%" border="0" cellspacing="1" cellpadding="2">
								  ...
								  <tr class="odd">
									  ...
									  <input type="submit" name="Export" class="inputbutton" value="Export in Excel" />
									</td>
								  </tr>
								  ...
								  <tr class="even">
									...
									<!--<td align="center">
									  <a href="<?=$this->url(array('controller'=>'Roireport','action'=>'graphicalview'),'default',true)?>" class="new_link" target="_blank">Graphical Report</a>
							   ...
							   <tr>
									...
									<th style="width:8%; text-align:center"><?=CommonFunction::OrderBy('CRM Amount','AT.total_value')?></th>
                            ...
                            <tbody>
							 ...
							 if(count($this->rois['Records'])>0){
								...
								<tr class="<?php echo  $class;?>">
								  ...
								  <td align="center">
								  	<a href="<?=$this->url(array('controller'=>'roireport','action'=>'detailreport','token'=>Class_Encryption::encode($roi['doctor_id'])),'default',true)?>"><img src="<?=Bootstrap::$baseUrl;?>public/admin_images/salaryslip.png" title="View Detail Report" /></a>
                                  </td>
								</tr>
								<?php } } else{ ?>
								<tr>
