                        ...
                        <table id="myTable" class="tablesorter">
							...
							<tr class="odd">
                              ...
                              <td colspan="8">
                                ...
                                <input type="submit" name="search" value="Search" class="submit-green" /> &nbsp;
								<input type="submit" name="expdata" value="Export Data" class="submit-green" />
                              </td>
							</tr>
